...
//   public async Task<Customer?> GetByIdAsync(int id, bool includeSales = false)
//   {
//     try
//     {
//       if (includeSales)
//       {
//         return await db.Customers.Include(c => c.Sales).Where(c => c.CustomerId == id && !c.IsDeleted).FirstOrDefaultAsync();
//       }
