...
//   [HttpGet("{id}")]
//   public async Task<ActionResult<ResponseDto<GetCustomerDto>>> GetById([FromRoute] int id, [FromQuery] bool includeSales = false)
//   {
//     try
//     {
//       var currentCustomer = await customerRepo.GetByIdAsync(id, includeSales);
